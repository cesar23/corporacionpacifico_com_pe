...
@$cliente_nombre = $objStrin->Oracion(trim($request->suscrip_nombre));
//--email del cliente
@$cliente_mail =trim($request->suscrip_email);
//---
...
// Debes editar las próximas dos líneas de código de acuerdo con tus preferencias
	...
	//$email_from="ventas@northcote.pe";
						...
						$email_subject = "Usted se ah suscrito con exito a nuestros Boletines Diarios";
...
//-----------------------------------------------------------------
						...
						$headers_ofi .= "From: Corporacion E Inversiones del Pacifico S.A.C - Pedido <".$email_envio.">\r\n";
...
//---mail oficiona
							$email_subject = "Solicitud de Ventas";
							$email_message=$objFun->getCartaVenta($cliente_nombre,$cliente_mail,$telefono_mail,$comentario_mail,$objFun->getFechaLarga(),'http://corporacionpacifico.com.pe/');
